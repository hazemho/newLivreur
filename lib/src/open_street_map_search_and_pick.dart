...
import 'package:monlivreur/src/wide_button.dart';
...
class _OpenStreetMapSearchAndPickState
  ...
  void setNameCurrentPos() async {
    ...
    String url =
        'https://nominatim.openstreetmap.org/reverse?accept-language=fr&format=json&lat=$latitude&lon=$longitude&zoom=18&addressdetails=1';
  ...
  void initState() {
    ...
    _mapController.mapEventStream.listen((event) async {
      if (event is MapEventMoveEnd) {
        var client = http.Client();
        String url =
            'https://nominatim.openstreetmap.org/reverse?accept-language=fr&format=json&lat=${event.center.latitude}&lon=${event.center.longitude}&zoom=18&addressdetails=1';
                  ...
                  TextFormField(
                      ...
                      onChanged: (String value) {
                        ...
                        _debounce =
                          ...
                          try {
                            String url =
                                'https://nominatim.openstreetmap.org/search?q=$value&accept-language=fr&format=json&polygon_geojson=1&addressdetails=1';
                            if (kDebugMode) {
                              print(url);
                            }
                            var response = await client.post(Uri.parse(url));
  ...
  Future<PickedData> pickData() async {
    ...
    var client = http.Client();
    String url =
        'https://nominatim.openstreetmap.org/reverse?accept-language=fr&format=json&lat=${_mapController.center.latitude}&lon=${_mapController.center.longitude}&zoom=18&addressdetails=1';
