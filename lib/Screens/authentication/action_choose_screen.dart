...
class ActionChooseScreen extends StatelessWidget {
  const ActionChooseScreen({Key? key}) : super(key: key);
                ...
                DefaultActionButton(isLoading: false,
                  ...
                  onClickCallback: () {
                   /// context.router.navigate(PhoneNumberScreenRoute(userType: 1));
                    Navigator.push(context, FadeRoute(page: RegisterChooseScreen()),);
                  },
                ),
                DefaultActionButton(isLoading: false,
